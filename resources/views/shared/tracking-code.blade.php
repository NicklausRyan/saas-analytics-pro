...
<div class="position-relative">
    <textarea name="tracking_code" class="form-control" id="i-tracking-code" rows="3" onclick="this.select();" readonly>&lt;script data-host=&quot;{{ config('app.url') }}&quot; data-dnt=&quot;{{ config('settings.do_not_track') ? 'true' : 'false' }}&quot;@if(config('settings.key_restriction') == 1 && isset($website->domain_key)) data-key=&quot;{{ $website->domain_key }}&quot;@endif src=&quot;{{ !empty(config('settings.cdn_url')) ? config('settings.cdn_url') : asset('js/script.js') }}&quot; id=&quot;ZwSg9rf6GA&quot; async defer&gt;&lt;/script&gt;</textarea>
