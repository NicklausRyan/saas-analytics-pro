                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="d-flex align-items-center text-truncate text-success">
                                        ...
                                        <div class="flex-grow-1 text-truncate {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ mb_strtolower(__('Most common')) }}</div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="d-flex align-items-center text-truncate text-danger">
                                        ...
                                        <div class="flex-grow-1 text-truncate {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ mb_strtolower(__('Least common')) }}</div>
                        ...
                        <div class="list-group-item px-0 border-0">
                            <div class="d-flex flex-column">
                                ...
                                <div class="progress height-1.25 w-100">
                                    <div class="progress-bar bg-primary rounded" role="progressbar" style="width: {{ (($exitPage->count / $total->count) * 100) }}%"></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
